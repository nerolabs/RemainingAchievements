-- esES (machine translation). Missing keys fall back to enUS via RA.L.
local ADDON_NAME, RA = ...;
...
L["Press %s+C to copy, then paste directly into Google Sheets or Excel."] = "Pulsa %s+C para copiar y luego pega directamente en Google Sheets o Excel.";
L["Press %s+C to copy, then paste into your report."] = "Pulsa %s+C para copiar y luego pega en tu informe.";
